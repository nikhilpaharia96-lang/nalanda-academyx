...
export const storeProductImages = sqliteTable("store_product_images", {
  id: id(),
...
export const storeProductClasses = sqliteTable("store_product_classes", {
  id: id(),
  productId: text("product_id").notNull().references(() => storeProducts.id, { onDelete: "cascade" }),
  classId: text("class_id").notNull().references(() => classes.id, { onDelete: "cascade" }),
}, (t) => ({
...
export const storeProductVariants = sqliteTable("store_product_variants", {
  id: id(),
  productId: text("product_id").notNull().references(() => storeProducts.id, { onDelete: "cascade" }),
...
export const storeInventoryTransactions = sqliteTable("store_inventory_transactions", {
  id: id(),
  productId: text("product_id").notNull().references(() => storeProducts.id, { onDelete: "cascade" }),
...
export const storeCoupons = sqliteTable("store_coupons", {
  id: id(),
...
export const storeBundles = sqliteTable("store_bundles", {
  id: id(),
  name: text("name").notNull(),
  description: text("description"),
  classId: text("class_id").references(() => classes.id),
...
export const storeBundleItems = sqliteTable("store_bundle_items", {
  id: id(),
