...
export const PAYMENT_TYPES = ["ADMISSION", "MONTHLY_FEE", "EXTRA_FEE", "STORE_ORDER", "OTHER"] as const;
...
export const STORE_PRODUCT_STATUSES = ["ACTIVE", "INACTIVE", "ARCHIVED"] as const;

export const STORE_INVENTORY_TRANSACTION_TYPES = [
  "RESTOCK",
  "ADJUSTMENT",
  "RESERVE",
  "RELEASE",
...
export const STORE_FULFILLMENT_METHODS = ["PICKUP", "DELIVERY"] as const;
...
export const STORE_COUPON_DISCOUNT_TYPES = ["PERCENT", "FLAT"] as const;
