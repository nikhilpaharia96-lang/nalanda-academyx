...
export const createRazorpayOrderSchema = z.object({
  ...
  storeOrderId: z.string().optional(), // School Store checkout — reuses this same Razorpay flow
...
export const recordOfflinePaymentSchema = z
  ...
  .refine((dto) => dto.studentFeeId || dto.extraFeeId || dto.storeOrderId, {
    message: "An offline payment must be linked to a student fee, an extra fee, or a School Store order",
    path: ["studentFeeId"],
  });
