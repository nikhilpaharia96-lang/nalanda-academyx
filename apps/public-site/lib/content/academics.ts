...
export const academicStats = {
  ...
  stats: [
    { icon: "graduation-cap" as const, value: "1250", label: "Students" },
    { icon: "user-check" as const, value: "5", label: "Faculty" },
    { icon: "book-open" as const, value: "18", label: "Subjects Offered" },
    { icon: "trophy" as const, value: "96%", label: "Success Rate" },
  ],
